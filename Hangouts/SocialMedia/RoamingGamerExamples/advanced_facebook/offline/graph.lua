...
buttonActions[6] = { "Get Taggable Friends (right)", getTaggableFriendsList }
buttonActions[7] = { "Feed Dialog", showFeedDialog }

for i = 1, #buttonActions do
	PushButton( sceneGroup, centerX, centerY - 200 + i * 50, buttonActions[i][1], buttonActions[i][1], 
...
--complexDirectPost()
--getMe()
--getFriendsList() -- Not right.  Here for example of wrong call.
--getTaggableFriendsList() -- This will get a friends list.
--showFeedDialog()
