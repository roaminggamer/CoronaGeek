...
function scene:create( event )
	...
	local label = display.newEmbossedText( sceneGroup, "Game Over", centerX, 40, native.systemFont, 60 )
	...
	-- Create a button
	local push1 = PushButton( sceneGroup, centerX, centerY - 100, "Play Again", onPlayAgain, 
	                          { labelColor = {0.8,0.2,0.2}, labelSize = 18 } )


	-- Create a button
	local push2 = PushButton( sceneGroup, centerX, centerY + 100, "Main menu", onHome, 
	                          { labelColor = {0.8,0.2,0.2}, labelSize = 18 } )
...
----------------------------------------------------------------------
onPlayAgain = function ( self, event ) 
