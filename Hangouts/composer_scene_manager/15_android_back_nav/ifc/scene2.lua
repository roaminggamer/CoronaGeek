...
function scene:create( event )
	...
	PushButton( sceneGroup, centerX, centerY, "Go To Scene 4", onGotoScene4, { labelColor = {0,1,1}, labelSize = 24 } )
...
onGotoScene4 = function ( self, event ) 
	composer.gotoScene( "ifc.scene4", options  )	
	return true
end
