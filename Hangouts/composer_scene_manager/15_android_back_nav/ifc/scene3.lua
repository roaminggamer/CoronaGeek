...
function scene:create( event )
	...
	local label = display.newEmbossedText( sceneGroup, "Scene 3", centerX, 40, native.systemFont, 60 )
	...
	PushButton( sceneGroup, centerX, centerY, "Go To Scene 5", onGotoScene5, { labelColor = {0,1,1}, labelSize = 24 } )
	PushButton( sceneGroup, centerX, centerY + 100, "Back To Scene 1", onBack, { labelColor = {0,0,0}, labelSize = 24 } )
...
onGotoScene5 = function ( self, event ) 
	composer.gotoScene( "ifc.scene5", options  )	
	return true
end
