...
function scene:willEnter( event )
	...
	local label = display.newEmbossedText( disposeGroup, "Scene 1", centerX, 40, native.systemFont, 60 )
	...
	local sceneChange Button = PushButton( disposeGroup, centerX, centerY - 50, "Go To Scene 2", onChangeScene, 
	                          { labelColor = {0,1,0}, labelSize = 18, width = 200 } )


	-- Create an object and move it.
	--
	local test = display.newCircle( disposeGroup, centerX, centerY, 20 )
