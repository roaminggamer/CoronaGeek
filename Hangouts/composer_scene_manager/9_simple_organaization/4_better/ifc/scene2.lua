...
buildScene = function( group )
	...
	local label = display.newEmbossedText( group, "Scene 2", centerX, 40, native.systemFont, 60 )
	...
	local sceneChange Button = PushButton( group, centerX, centerY - 50, "Go To Scene 1", onChangeScene, 
	                          { labelColor = {0,1,0}, labelSize = 18, width = 200 } )


	-- Create an object and move it.
	--
	local test = display.newRect( group, 0, 0, 40, 40  )
	test.x = centerX
	test.y = centerY
