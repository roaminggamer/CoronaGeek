...
function scene:create( event )
	...
	local sceneChange Button = PushButton( sceneGroup, centerX, centerY - 50, "Go To Scene 2", onChangeScene, 
	                          { labelColor = {0,1,0}, labelSize = 18, width = 200 } )


	-- Create an object and move it.
	--
	local test = display.newCircle( sceneGroup, centerX, centerY, 20 )
...
function scene:didExit( event )
	local sceneGroup = self.view
	composer.removeScene( 'ifc.scene1', false )
end
