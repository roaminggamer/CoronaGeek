...
-- =============================================================
-- Scene 3 - Another Right Way To Manage Objects (Sprites) In Module (via Composer)
-- =============================================================
local composer 		= require( "composer" )
local scene    		= composer.newScene()

local spriteModule = require "scripts.spriteModule_best"
...
function scene:create( event )
	...
	local label = display.newText( sceneGroup, "Sprite Module Sample - Best", centerX, 40, native.systemFont, 20 )
...
function scene:destroy( event )
	...
	local sceneGroup = self.view
	spriteModule.destroy()
	--spriteModule.destroy( "scripts.spriteModule_best" )
end
