...
-- =============================================================
-- Scene 1 - Wrong Way To Manage Objects (Sprites) In Module (via Composer)
-- =============================================================
local composer 		= require( "composer" )
local scene    		= composer.newScene()

local spriteModule = require "scripts.spriteModule_wrong"
...
function scene:create( event )
	...
	local label = display.newText( sceneGroup, "Sprite Module Sample - OK", centerX, 40, native.systemFont, 20 )
	...
	local spriteInstance = spriteModule.create( centerX, centerY )
