...
function scene:create( event )
	...
	local label = display.newText( sceneGroup, "Memory", centerX, centerY - 40, system.nativeFontBold, 40 )
	label.x = label.x-1
	label.y = label.y-1
	local label = display.newText( sceneGroup, "Memory", centerX, centerY - 40, system.nativeFontBold, 40 )
	...
	local label = display.newText( sceneGroup, "Flipper", centerX, centerY + 40, system.nativeFontBold, 40 )
	label.x = label.x-1
	label.y = label.y-1
	local label = display.newText( sceneGroup, "Flipper", centerX, centerY + 40, system.nativeFontBold, 40 )
	label:setFillColor( 0xff/255, 0x59/255, 0x1c/255 )
