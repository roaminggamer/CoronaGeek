...
function public.create( parent, duration  )	
	...
	scoreLabel = display.newText( layers.overlay, msgPrefix .. "0", right - 10, back.y, native.systemFont, 20 )
	...
	scoreLabel.onScore = function( self, event )
		...
		self.text = msgPrefix .. self.currentScore
	end
	-- Start listening
	--
	...
	timerLabel = display.newText( layers.overlay, msgPrefix .. duration, left + 10, back.y, native.systemFont, 20 )
