...
function public.get( levelNum )	
	...
	--[[
	level =  {
		{ type = 'player', x = centerX, y = centerY - common.blockSize - common.playerSize/2, rotation = 0 },
		{ type = 'circle1', x = centerX, y = centerY, rotation = 0 },
		{ type = 'circle1', x = centerX + common.gapSize , y = centerY, rotation = 0 },
	}
	--]]
