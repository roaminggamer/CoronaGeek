...
function scene:create( event )
	...
	local label = display.newText( sceneGroup, "Monsters Need", centerX, centerY - 40, "Harrowprint", 60 )
	label.x = label.x-1
	label.y = label.y-1
	local label = display.newText( sceneGroup, "Monsters Need", centerX, centerY - 40, "Harrowprint", 60 )
	...
	local label = display.newText( sceneGroup, "Coins", centerX, centerY + 40, "Harrowprint", 60 )
	label.x = label.x-1
	label.y = label.y-1
	local label = display.newText( sceneGroup, "Coins", centerX, centerY + 40, "Harrowprint", 60 )
	label:setFillColor( 0xff/255, 0x59/255, 0x1c/255 )
	...
	--
	local timerHandle = timer.performWithDelay( splashTime, goToMainMenu )
