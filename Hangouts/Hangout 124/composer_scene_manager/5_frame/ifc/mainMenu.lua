...
function scene:create( event )
	...
	local label = display.newEmbossedText( screenGroup, "Main Menu", centerX, 40, native.systemFont, 60 )
	...
	local playButton = PushButton( screenGroup, centerX, centerY, "Play", onPlay, 
	                          { labelColor = {0,1,0}, labelSize = 18 } )

	local optionsButton = PushButton( screenGroup, centerX, centerY + 50, "Options", onOptions, 
