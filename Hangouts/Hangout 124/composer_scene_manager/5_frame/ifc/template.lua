...
function scene:create( event )
	...
	local label = display.newEmbossedText( screenGroup, "Template", centerX, 40, native.systemFont, 60 )
	...
	-- Create a button
	local push1 = PushButton( screenGroup, centerX, centerY, "Push Me", onPush1, 
