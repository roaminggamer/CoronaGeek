...
function scene:create( event )
	...
	local label = display.newEmbossedText( screenGroup, "Play GUI", centerX, 40, native.systemFont, 60 )
	...
	-- Create a button
	local push1 = PushButton( screenGroup, centerX, centerY, "Back", onBack, 
