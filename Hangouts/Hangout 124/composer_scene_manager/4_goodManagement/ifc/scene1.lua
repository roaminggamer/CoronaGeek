...
function scene:create( event )
	...
	local label = display.newText( screenGroup, "Scene 1", centerX, 40, native.systemFont, 30 )
	

	-- Create a button
	PushButton( screenGroup, centerX, centerY, "Scene 2", onScene2, 
	                          { labelColor = {1,0,0}, labelSize = 18 } )


	for i = 1, 10 do
		local tmp = display.newCircle( screenGroup, mRand( 20, w-20 ), mRand( 20, h-20 ), mRand( 10, 20) )
