...
function scene:create( event )
	...
	local labelBack = display.newRect( screenGroup, w-60, 15, 120, 30)
	local label = display.newText( screenGroup, "Scene 1", labelBack.x, labelBack.y, native.systemFont, 20 )
	label:setFillColor(0,1,0)

	

	-- Create a button
	PushButton( screenGroup, w - 50, h - 150, "Scene 2", onScene2, 
	                          { labelColor = {1,0,0}, labelSize = 18 } )

	PushButton( screenGroup, w - 50, h - 50, "Overlay 1", onOverlay1, 
